...
public class Controlador_DoacaoDeItens {
  ...
  @GetMapping("/listarDoacoesDeItensPorCampanha/{idCampanhaDeItens}")
  public Iterable<DoacaoDeItens> listarDoacoesDeItensPorCampanha(@PathVariable CampanhaDeItens idCampanhaDeItens) {
      return Repositorio_DoacaoDeItens.findByCampanhaDeItens(idCampanhaDeItens);
  }
