    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                    ...
                    .authorizeHttpRequests(request -> request
                                                            .requestMatchers("/salvarUsuario", "/salvarONG","/login", "/loginOng","/listarCampanhasFinanceiras", "/listarCampanhasDeItens", "/imagem/**").permitAll().anyRequest().authenticated())//Todas as requisições de HTTP precisam ser autenticadas, no nosso caso, com httpBasic
